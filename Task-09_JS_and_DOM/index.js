...
document.querySelector(".clearVowel").addEventListener('mousedown',function(){
    document.getElementById("vowel").value = "";
    document.querySelector(".vowelResult").textContent = " ";
}) 


document.querySelector(".clearDegree").addEventListener('mousedown',function(){
    document.getElementById("degree").value = "";
    document.querySelector(".degreeResult").textContent = " ";
})

document.querySelector(".clearEleminate").addEventListener('mousedown',function(){
...
document.querySelector(".vowel-btn").addEventListener('mousedown',  function() {
    document.querySelector(".vowelResult").textContent = vowelCount(document.getElementById("vowel").value)
})

document.querySelector(".degree-btn").addEventListener('mousedown', function() {
    document.querySelector(".degreeResult").textContent = sumDegree(parseInt(document.getElementById("degree").value))
})

document.querySelector(".eleminate-btn").addEventListener('mousedown',  function() {
